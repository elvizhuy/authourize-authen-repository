    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.index') }}">
                ...
                <div class="sidebar-brand-text mx-3">Elviz Huy<sup>2</sup></div>
            </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapse_posts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            @can('posts.add')
                                <a class="collapse-item" href="{{ route('admin.posts.add') }}">Add new</a>
                            @endcan
                        </div>
                    </div>
                </li>
            ...
            @can('groups')
                <li class="nav-item">
                    ...
                    <div id="collapse_groups" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Options:</h6>
                            <a class="collapse-item" href="{{ route('admin.groups.index') }}">List</a>
                            @can('groups.add')
                            <a class="collapse-item" href="{{ route('admin.groups.add') }}">Add new</a>
                            @endcan
                        </div>
                    </div>
                </li>
            ...
            @can('users')
                <li class="nav-item">
                    ...
                    <div id="collapse_users" class="collapse" aria-labelledby="headingUtilities"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Utilities:</h6>
                            <a class="collapse-item" href="{{ route('admin.users.index') }}">List</a>
                            @can('users.add')
                                <a class="collapse-item" href="{{ route('admin.users.add') }}">Add new</a>
                            @endcan
                        </div>
                    </div>
                </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="{{asset('admins')}}/img/undraw_rocket.svg" alt="...">
